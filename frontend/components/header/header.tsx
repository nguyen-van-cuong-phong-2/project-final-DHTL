...
import NotifiIcon from "@/public/images/notifications.png";
...
export default function Header() {
  ...
  return (
    <>
      <div
        className="flex border shadow-md p-3 justify-between
      "
      >
        ...
        <div className="flex gap-3">
          <div className="border rounded-full h-max w-max p-3 bg-BGICon">
            <svg
              viewBox="0 0 24 24"
              width="20px"
              height="20px"
