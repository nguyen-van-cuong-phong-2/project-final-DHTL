    ...
    <>
      <div className="w-full flex items-center h-screen bg-gray-100 gap-10">
        ...
        <div className=" w-1/3 h-max rounded pt-5 flex-row justify-center bg-white shadow-2xl">
          ...
          <Link href={""} className="text-blue-500 w-10/12 ml-[200px] mt-60 h-16">Quên mật khẩu?</Link>
          <button className="bg-green-600 w-11/12 ml-6 mt-5 h-16 rounded border-2 text-2xl font-bold text-white mb-5">
              Tạo tài khoản mới
          </button>
        </div>
      </div>
