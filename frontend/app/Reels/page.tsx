...
const Componentt = ({ name, avatar, created_at, setMute, mute }) => {
    ...
    return (
        <div className='flex gap-2 ml-10 max-md:ml-[-15px]'>
            ...
            <div className='absolute text-white right-28 cursor-pointer z-[9999]' onClick={() => setMute(prev => !prev)}>
...
export default function Index() {
    ...
    return (<>
        <div className='flex w-screen h-screen m-0 gap-8 bg-black flex-col relative '>
            <div className='absolute left-[30%] max-lg:left-[5%]  max-lg:top-16'>
            ...
            <div className='absolute top-0 left-32 max-lg:right-0 flex gap-2 items-center mt-2 max-lg:left-[0]'>
